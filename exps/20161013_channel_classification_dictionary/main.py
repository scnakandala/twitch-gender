...
gendered_terms = [r'\bhe\b', r'\bhes', r'\bshe\b', r'\bshes\b', r'\bhis\b', r'\bher\b', r'\bbro\b',
                          ...
                          r'\bgurl\b',r'\bhims\b', r'\bhers\b', r'\bhisself\b', r'\bherself\b', r'\bman\b', r'\bwoman\b']
...
def generate_channel_chats_d2v(channel_list, is_sample=True):
        ...
        if file_name.endswith('.csv'):
            ...
            with open(file_path, 'r') as fp:
                ...
                for line in fp:
                    ...
                    message = ' '.join([x for x in message.split() if x in dictionary_words])
    ...
    model = Doc2Vec(min_count=1, window=5, size=100, sample=1e-5, negative=5, workers=8, dm=0, dbow_words=1)
